"""
Custom exception that wraps any error with rich debugging context, including
source file, line number, and full traceback. Designed to preserve exception
details when re-raising errors and to produce clean, logger-friendly messages
for production logging and debugging.
"""

# A traceback in Python is an error message (also known as a stack trace) that
# provides a detailed report of the sequence of function calls that were active
