# This file contains pytest fixtures that are used in multiple tests.
import io
import json
import os
import pathlib
...
os.environ.setdefault("PYTHONPATH", ".../end_to_end_rag_project")
...
# A fixture is setup code that pytest runs for you and injects into tests automatically.
@pytest.fixture
def clear_sessions():
    main.SESSIONS.clear()
    yield
...
def stub_model_loader(monkeypatch):
    ...
    import multi_doc_chat.src.DataIngestion as di
    import multi_doc_chat.src.retreival as r
